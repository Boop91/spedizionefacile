...
## Dove stanno ora gli helper manuali

Gli script di supporto non vivono piu' nel root del backend.

- `scripts/pudo/ATTIVA_PUDO.bat`
- `scripts/pudo/IMPORTA_PUDO.bat`
- `scripts/pudo/setup-pudo-fallback.sh`
- `scripts/pudo/check-pudo-sqlite.php`

Questa guida resta in `docs/riferimento/operativo/` perche' e' un manuale tecnico, non una parte del runtime.
