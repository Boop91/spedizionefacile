...
class BrtConfig
{
    ...
    {
        return $this->clientId !== '' && $this->password !== '';
    }

    public function isPudoConfigured(): bool
    {
        return $this->pudoToken !== '';
    }

    public function shipmentHttp(): \Illuminate\Http\Client\PendingRequest
    {
        return Http::withBasicAuth($this->clientId, $this->password)
            ->withOptions(['verify' => $this->verifySsl])
            ->timeout(30);
    }

    public function pudoHttp(): \Illuminate\Http\Client\PendingRequest
    {
        return Http::withHeaders(['Authorization' => 'Bearer '.$this->pudoToken])
            ->withOptions(['verify' => $this->verifySsl])
            ->timeout(15);
    }
}
